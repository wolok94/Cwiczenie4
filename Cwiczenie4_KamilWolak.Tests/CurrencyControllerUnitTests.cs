...
using Cwiczenie4_KamilWolak.Api.Controllers;
...
public class CurrencyControllerUnitTests
{
    ...
    public CurrencyControllerUnitTests()
    {
    ...
    public async Task GetCurrenciesWithValidCurrencies()
    {
        ...
        var controller = new CurrencyControllerUnit(_currencyService.Object, _exchangeTableService.Object);
